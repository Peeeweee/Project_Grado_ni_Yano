...
const GE_COMMONS = {
    ...
    GE319: { id: "GE 319", code: "GE 319", title: "Contemporary World", units: 3 },
    EGE311: { id: "EGE 311", code: "EGE 311", title: "Gen Ed Elective 1", units: 3 },
    EGE312: { id: "EGE 312", code: "EGE 312", title: "Gen Ed Elective 2", units: 3 },
    EGE313: { id: "EGE 313", code: "EGE 313", title: "Gen Ed Elective 3", units: 3 },
    PE111: { id: "PE 111", code: "PE 111", title: "Movement Enhancement", units: 2 },
    PE122: { id: "PE 122", code: "PE 122", title: "Fitness Exercise", units: 2 },
    PE213: { id: "PE 213", code: "PE 213", title: "PATHFit I", units: 2 },
    PE224: { id: "PE 224", code: "PE 224", title: "PATHFit II", units: 2 },
    NSTP111: { id: "NSTP 111", code: "NSTP 111", title: "National Service Training Program", units: 3 },
    NSTP122: { id: "NSTP 122", code: "NSTP 122", title: "National Service Training Program", units: 3 },
    ...
    IC125: { id: "IC 125", code: "IC 125", title: "Discrete Math", units: 3 },
    IC126: { id: "IC 126", code: "IC 126", title: "Interaction Design", units: 3 },
    IC217: { id: "IC 217", code: "IC 217", title: "Data Structures", units: 3 },
    ...
    ICE414: { id: "ICE 414", code: "ICE 414", title: "Prof Elective 4", units: 3 },
    ICE415: { id: "ICE 415", code: "ICE 415", title: "Prof Elective 5", units: 3 },
};
...
export const CURRICULUMS = {
    "BS in Information Technology (Specialization: Information Security)": [
        ...
        },
        {
            ...
            subjects: [GE_COMMONS.EGE311, GE_COMMONS.GE319, { id: "ITIS 311", code: "ITIS 311", title: "Fundamentals in Security Design", units: 3 }, { id: "ITIS 312", code: "ITIS 312", title: "Identity Management", units: 3 }, { id: "ITIS 313", code: "ITIS 313", title: "Information Storage Security", units: 3 }, { id: "ITIS 314", code: "ITIS 314", title: "Cybersecurity", units: 3 }, { id: "IT 319", code: "IT 319", title: "Software Engineering 2", units: 3 }, GE_COMMONS.ICE311]
        },
        {
            name: "3rd Year - 2nd Semester",
            subjects: [GE_COMMONS.EGE312, GE_COMMONS.EGE313, { id: "ITIS 325", code: "ITIS 325", title: "Systems and Administration", units: 3 }, { id: "ITIS 326", code: "ITIS 326", title: "Data Privacy and Security", units: 3 }, { id: "ITIS 327", code: "ITIS 327", title: "Security Policy and Governance", units: 3 }, GE_COMMONS.ICE322, GE_COMMONS.ICE323, { id: "IT 3210", code: "IT 3210", title: "IT Research Paradigm", units: 3 }]
        },
        {
            name: "Summer",
    ...
    "BS in Computer Science (Specialization: Data Science)": [
        {
            name: "1st Year - 1st Semester",
            subjects: [GE_COMMONS.GE111, GE_COMMONS.GE112, GE_COMMONS.IC111, GE_COMMONS.IC112, GE_COMMONS.IC113, { id: "CS 111", code: "CS 111", title: "Advanced Algebra", units: 3 }, GE_COMMONS.PE111, GE_COMMONS.NSTP111]
        },
        {
            name: "1st Year - 2nd Semester",
            subjects: [GE_COMMONS.GE113, GE_COMMONS.GE114, GE_COMMONS.IC124, GE_COMMONS.IC125, GE_COMMONS.IC126, { id: "CS 122", code: "CS 122", title: "Intro to Data Science", units: 3 }, GE_COMMONS.PE122, GE_COMMONS.NSTP122]
        },
        {
            name: "2nd Year - 1st Semester",
            subjects: [GE_COMMONS.GE215, GE_COMMONS.GE216, GE_COMMONS.IC217, { id: "CS 213", code: "CS 213", title: "Database Management Systems", units: 3 }, { id: "CS 214", code: "CS 214", title: "Computer Networks Concepts and Theories", units: 3 }, { id: "CS 215", code: "CS 215", title: "Design and Analysis of Algorithm", units: 3 }, GE_COMMONS.PE213]
        },
        {
            name: "2nd Year - 2nd Semester",
            subjects: [GE_COMMONS.GE217, GE_COMMONS.GE218, { id: "CS 226", code: "CS 226", title: "Data Analytics", units: 3 }, { id: "CS 227", code: "CS 227", title: "Automata Theory", units: 3 }, { id: "CS 228", code: "CS 228", title: "Artificial Intelligence", units: 3 }, { id: "CS 229", code: "CS 229", title: "Design and Development Methodologies", units: 3 }, GE_COMMONS.PE224]
        },
        {
            name: "3rd Year - 1st Semester",
            subjects: [GE_COMMONS.EGE311, GE_COMMONS.GE319, { id: "CSDS 311", code: "CSDS 311", title: "Big Data Management", units: 3 }, { id: "CSDS 312", code: "CSDS 312", title: "Applied Data Science", units: 3 }, { id: "CSDS 313", code: "CSDS 313", title: "Business Intelligence", units: 3 }, { id: "CSDS 314", code: "CSDS 314", title: "Machine Learning", units: 3 }, { id: "CS 3110", code: "CS 3110", title: "Modelling and Simulation", units: 3 }, GE_COMMONS.ICE311]
        },
        {
            name: "3rd Year - 2nd Semester",
            subjects: [GE_COMMONS.EGE312, GE_COMMONS.EGE313, { id: "CSDS 325", code: "CSDS 325", title: "Intelligent Info Systems", units: 3 }, { id: "CSDS 326", code: "CSDS 326", title: "Social Network Analysis", units: 3 }, { id: "CSDS 327", code: "CSDS 327", title: "Data Visualization", units: 3 }, GE_COMMONS.ICE322, GE_COMMONS.ICE323, { id: "CS 3211", code: "CS 3211", title: "CS Research Methods", units: 3 }]
        },
        {
            name: "Summer",
            subjects: [{ id: "Thesis 400_S", code: "Thesis 400", title: "Thesis", units: 2 }, { id: "CSPR 331", code: "CSPR 331", title: "Practicum", units: 3 }]
        },
        {
            name: "4th Year - 1st Semester",
            subjects: [GE_COMMONS.ICE414, GE_COMMONS.ICE415, { id: "Thesis 400_41", code: "Thesis 400", title: "Thesis", units: 3 }]
        },
        {
            name: "4th Year - 2nd Semester",
            subjects: [{ id: "CS 4212", code: "CS 4212", title: "Legal, Ethical, Policy Issues in Data Science", units: 3 }, { id: "Thesis 400_42", code: "Thesis 400", title: "Thesis", units: 3 }]
        }
    ],
    "BS in Information Technology (Specialization: Business Technology Management)": [
        {
        ...
        {
            name: "3rd Year - 1st Semester",
            subjects: [GE_COMMONS.EGE311, GE_COMMONS.GE319, { id: "ITBTM 311", code: "ITBTM 311", title: "Intro to BTM", units: 3 }, { id: "ITBTM 312", code: "ITBTM 312", title: "IT Accounting", units: 3 }, { id: "ITBTM 313", code: "ITBTM 313", title: "Marketing Principles", units: 3 }, { id: "ITBTM 314", code: "ITBTM 314", title: "Enterprise Resource Planning", units: 3 }, { id: "IT 319", code: "IT 319", title: "Software Engineering 2", units: 3 }, GE_COMMONS.ICE311]
        },
        {
            name: "3rd Year - 2nd Semester",
            subjects: [GE_COMMONS.EGE312, GE_COMMONS.EGE313, { id: "ITBTM 325", code: "ITBTM 325", title: "E-Commerce", units: 3 }, { id: "ITBTM 326", code: "ITBTM 326", title: "Adv. Technopreneurship", units: 3 }, { id: "ITBTM 327", code: "ITBTM 327", title: "Business Analytics", units: 3 }, GE_COMMONS.ICE322, GE_COMMONS.ICE323, { id: "IT 3210", code: "IT 3210", title: "IT Research Paradigm", units: 3 }]
        },
        {
            name: "Summer",
            subjects: [{ id: "ITCP 400_S", code: "ITCP 400", title: "Capstone Project", units: 2 }, { id: "ITPR 401_S", code: "ITPR 401", title: "IT Practicum", units: 5 }]
